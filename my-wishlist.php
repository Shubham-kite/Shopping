...
if(isset($_GET['del']))
{
$query=pg_query($con,"delete from wishlist where id='$wid'");
}


if(isset($_GET['action']) && $_GET['action']=="add"){
	$id=intval($_GET['id']);
	$query=pg_query($con,"delete from wishlist where productId='$id'");
...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			...
			<tbody>
<?php
$ret=pg_query($con,"select products.productName as pname,products.productName as proid,products.productImage1 as pimage,products.productPrice as pprice,wishlist.productId as pid,wishlist.id as wid from wishlist join products on products.id=wishlist.productId where wishlist.userId='".$_SESSION['id']."'");
$num=pg_num_rows($ret);
	if($num>0)
	{
...
<?php $rt=pg_query($con,"select * from productreviews where productId='$pd'");
$num=pg_num_rows($rt);
{
?>
