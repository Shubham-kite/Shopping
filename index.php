...
<?php
$ret=pg_query($con,"select * from products");
...
?>
	...
	<div class="tab-pane" id="books">
		...
		<?php
$ret=pg_query($con,"select * from products where category=3");
while ($row=pg_fetch_array($ret)) 
{
	# code...
	...
	<?php } ?>
		...
		<div class="tab-pane" id="furniture">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
$ret=pg_query($con,"select * from products where category=5");
while ($row=pg_fetch_array($ret)) 
{
?>
...
<?php
$ret=pg_query($con,"select * from products where category=4 and subCategory=4");
while ($row=pg_fetch_array($ret)) 
{
?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Laptops</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=pg_query($con,"select * from products where category=4 and subCategory=6");
while ($row=pg_fetch_array($ret)) 
{
?>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		...
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php
$ret=pg_query($con,"select * from products where category=6");
while ($row=pg_fetch_array($ret)) 
{
	# code...
