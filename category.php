...
{
pg_query($con,"insert into wishlist(userId,productId) values('".$_SESSION['id']."','".$_GET['pid']."')");
    ...
    <nav class="yamm megamenu-horizontal" role="navigation">
        ...
        <ul class="nav">
            <li class="dropdown menu-item">
              <?php $sql=pg_query($con,"select id,subcategory  from subcategory where categoryid='$cid'");
				...
				<div class="caption vertical-top text-left">
					<div class="big-text">
						<br />
					       ...
					       <?php $sql=pg_query($con,"select categoryName  from category where id='$cid'");
while($row=pg_fetch_array($sql))
{
    ?>
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active " id="grid-container">
							<div class="category-product  inner-top-vs">
								<div class="row">									
			<?php
$ret=pg_query($con,"select * from products where category='$cid'");
$num=pg_num_rows($ret);
if($num>0)
{
