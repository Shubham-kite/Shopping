...
header('location:index.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=pg_query($con,"update users set name='$name',contactno='$contactno' where id='".$_SESSION['id']."'");
		if($query)
		{
...
{
$sql=pg_query($con,"SELECT password FROM  users where password='".md5($_POST['cpass'])."' && id='".$_SESSION['id']."'");
$num=pg_fetch_array($sql);
if($num>0)
{
 $con=pg_query($con,"update students set password='".md5($_POST['newpass'])."', updationDate='$currentTime' where id='".$_SESSION['id']."'");
