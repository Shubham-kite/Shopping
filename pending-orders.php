...
header('location:login.php');
	...
	if (isset($_GET['id'])) {
		...
		pg_query($con,"delete from orders  where userId='".$_SESSION['id']."' and paymentMethod is null and id='".$_GET['id']."' ");
		;
