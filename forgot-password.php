...
$query=pg_query($con,"SELECT * FROM users WHERE email='$email' and contactno='$contact'");
$num=pg_fetch_array($query);
if($num>0)
{
$extra="forgot-password.php";
pg_query($con,"update users set password='$password' WHERE email='$email' and contactno='$contact' ");
