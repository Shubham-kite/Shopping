...
pg_query($con,"insert into orders(userId,productId,quantity) values('".$_SESSION['id']."','$qty','$val34')");
		...
		<tbody>
				<tr>
					<td>
						...
						<?php $qry=pg_query($con,"select * from users where id='".$_SESSION['id']."'");
while ($rt=pg_fetch_array($qry)) {
