...
header('location:index.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=pg_query($con,"update users set billingAddress='$baddress',billingState='$bstate',billingCity='$bcity',billingPincode='$bpincode' where id='".$_SESSION['id']."'");
		if($query)
		{
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		$query=pg_query($con,"update users set shippingAddress='$saddress',shippingState='$sstate',shippingCity='$scity',shippingPincode='$spincode' where id='".$_SESSION['id']."'");
		if($query)
		{
...
<?php
$query=pg_query($con,"select * from users where id='".$_SESSION['id']."'");
