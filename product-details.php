...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(pg_num_rows($query_p)!=0){
			$row_p=pg_fetch_array($query_p);
...
{
pg_query($con,"insert into wishlist(userId,productId) values('".$_SESSION['id']."','$pid')");
...
if(isset($_POST['submit']))
{
	...
	$review=$_POST['review'];
	pg_query($con,"insert into productreviews(productId,quality,price,value,name,summary,review) values('$pid','$qty','$price','$value','$name','$summary','$review')");
}
...
<?php
$ret=pg_query($con,"select category.categoryName as catname,subCategory.subcategory as subcatname,products.productName as pname from products join category on category.id=products.category join subcategory on subcategory.id=products.subCategory where products.id='$pid'");
...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	...
	<div class="sidebar-widget-body m-t-10">
		<div class="accordion">
		            ...
		            <?php $sql=pg_query($con,"select id,categoryName  from category");
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	...
	<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs">
								   ...
								   <?php
$ret=pg_query($con,"select * from products order by rand() limit 4 ");
while ($rws=pg_fetch_array($ret)) {
...
<?php 
$ret=pg_query($con,"select * from products where id='$pid'");
...
<?php $rt=pg_query($con,"select * from productreviews where productId='$pid'");
$num=pg_num_rows($rt);
{
?>		
...
<?php $qry=pg_query($con,"select * from productreviews where productId='$pid'");
while($rvw=pg_fetch_array($qry))
{
?>
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
		...
		<?php 
$qry=pg_query($con,"select * from products where subCategory='$subcid' and category='$cid'");
while($rw=pg_fetch_array($qry))
{
